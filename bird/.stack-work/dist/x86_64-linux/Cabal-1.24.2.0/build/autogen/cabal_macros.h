...
/* package bird-0.1.0.0 */
#define VERSION_bird "0.1.0.0"
#define MIN_VERSION_bird(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "bird-0.1.0.0-5aVSAYxsaiXGbJuh5ktiFR"

#define CURRENT_PACKAGE_KEY "bird-0.1.0.0-5aVSAYxsaiXGbJuh5ktiFR"
