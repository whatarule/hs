...
sysconfdir = "/home/wk/hs/hutton/.stack-work/install/x86_64-linux/lts-8.15/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "hutton_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "hutton_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "hutton_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "hutton_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hutton_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hutton_sysconfdir") (\_ -> return sysconfdir)
